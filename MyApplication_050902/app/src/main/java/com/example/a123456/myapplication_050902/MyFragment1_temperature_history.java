...
public class MyFragment1_temperature_history extends AppCompatActivity {
    private Queue<String> Usertemperature = new LinkedList<String>();//用于存储数据库的数据，然后作为历史记录的数据
    private Queue<String> Usertime = new LinkedList<String>();
    private Queue<String> Usertemperature2 = new LinkedList<String>();//作为折线图的数据。
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment1_temperature_history);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String sql = "select * from usertemperature where Userid ='" + User_id + "'order by Testtime desc;";
...
//        }, delay);
    ...
    /*
     *
     * 接收到myHandler发送的消息：0x126后开始做折线图和历史数据。
     */
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0x126) {
                ...
                while (Usertime.peek() != null) {
                    ...
                    showitem2.put("xueya", df.format(temperature));//体温
                ...
                ListView listView = (ListView) findViewById(R.id.list_temperature_view);
                ListView listView2 = (ListView) findViewById(R.id.list_temperature_view2);
                ListView listView3 = (ListView) findViewById(R.id.list_temperature_view3);

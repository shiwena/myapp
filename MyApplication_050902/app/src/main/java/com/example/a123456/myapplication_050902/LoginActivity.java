...
//                            String a="1";
                            ...
                            if(rs.next()) {Log.i("Mainactivity","有数据");flag=true;}
                            else{flag=false;Log.i("Mainactivity","没有数据");}
...
//                            Toast.makeText(MainActivity.this,"有东西",Toast.LENGTH_SHORT).show();
                                ...
                                else{Toast.makeText(LoginActivity.this,"登陆失败！账号或密码错误",Toast.LENGTH_SHORT).show();}
                            }
                            else{
